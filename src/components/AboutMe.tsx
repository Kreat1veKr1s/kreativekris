...
const testimonials = [
  {
    ...
    quote:
      "Working with KreativeKris completely transformed our online presence. Our leads increased by 340% and we finally rank on page one for all our target keywords. Absolute game-changer.",
    rating: 5,
    platform: "Google",
    platformUrl: "#",
    platformIcon: (
  ...
  },
  {
    ...
    quote:
      "The social media strategy they built for us was incredible. We went from zero to 25K followers in just 6 months. The content quality and engagement rates blew our expectations away.",
    rating: 5,
    platform: "LinkedIn",
    platformUrl: "#",
    platformIcon: (
  ...
  },
  {
    ...
    quote:
      "Their landing pages convert like crazy — 7.2% conversion rate! They truly understand persuasive copy and user psychology. Our cost per lead dropped 58% within the first quarter.",
    rating: 5,
    platform: "Upwork",
    platformUrl: "#",
    platformIcon: (
  ...
  },
  {
    ...
    quote:
      "My Google Business Profile went from barely visible to dominating local search. I'm getting 5x more calls and walk-ins. Best marketing investment I've ever made, hands down.",
    rating: 5,
    platform: "Yelp",
    platformUrl: "#",
    platformIcon: (
  ...
  },
  {
    ...
    quote:
      "The branding package they created perfectly captures our vision. From logo to social templates, everything is cohesive and beautiful. Our brand finally feels premium and professional.",
    rating: 5,
    platform: "Google",
    platformUrl: "#",
    platformIcon: (
  ...
  },
  {
    ...
    quote:
      "Their Google Ads management is phenomenal. We saw a 4.2x ROAS within the first month. The team is responsive, data-driven, and genuinely cares about our results.",
    rating: 5,
    platform: "LinkedIn",
    platformUrl: "#",
    platformIcon: (
...
const StarRating = ({ rating }: { rating: number }) => (
  <div className="flex gap-0.5">
    {Array.from({ length: 5 }).map((_, i) => (
      <Star key={i} className={`w-4 h-4 ${i < rating ? "text-amber-400 fill-amber-400" : "text-muted-foreground"}`} />
    ))}
  </div>
);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-14 items-start">
          ...
          >
            ...
            <div className="glass rounded-2xl p-6 md:p-8 relative overflow-hidden">
              ...
              <h3 className="font-heading text-2xl font-bold text-foreground mb-4">Hi, I'm Kristen 👋</h3>
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  A full-stack digital marketer who combines{" "}
                  <span className="text-primary font-medium">creative vision</span> with
                  <span className="text-primary font-medium"> data-driven strategy</span> to help brands grow, convert,
                  and dominate their markets.
                </p>
                <p>
                  From building high-converting websites and running profitable ad campaigns to managing social media
                  presences and crafting compelling content — I handle it all. My approach blends the latest AI tools
                  with proven marketing fundamentals.
                </p>
                <p>
                  Whether you're a startup looking to launch or an established brand ready to scale, I bring the{" "}
                  <span className="text-primary font-medium">strategy, creativity, and execution</span> to make it
                  happen.
                </p>
                <blockquote className="border-l-2 border-primary/40 pl-4 text-sm italic text-muted-foreground/80 mt-2">
                  "94% of organizations say influencer & content marketing outperforms traditional digital ads in 2026."
                  — Sprout Social
                </blockquote>
              </div>
