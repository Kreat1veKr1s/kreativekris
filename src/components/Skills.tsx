          ...
          <Accordion type="single" collapsible className="space-y-1">
            {certifications.map((cert) => (
              <AccordionItem key={cert.title} value={cert.title} className="border-border/30">
                ...
                <AccordionContent>
                  <div className="flex items-center justify-between pl-11 pt-1 pb-2">
                    <div>
                    ...
                    <a
                      ...
                      className="px-3 py-1.5 rounded-full text-xs font-medium bg-primary/10 text-primary hover:bg-primary/20 transition-colors flex items-center gap-1"
