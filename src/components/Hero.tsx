  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container max-w-5xl text-center px-6">
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold font-heading leading-tight mb-6 animate-slide-up" style={{ animationDelay: "0.1s" }}>
          Marketing That{" "}
        ...
        {/* Stats */}
        <div className="grid grid-cols-3 gap-8 mt-20 max-w-lg mx-auto animate-slide-up" style={{ animationDelay: "0.4s" }}>
          {[
